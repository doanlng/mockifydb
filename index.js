...
let songs = [
  {
    time: "02:56",
    trackName: "Excuses",
    artists: "AP Dhillon, Gurinder Gill, Insane",
  },
  {
    time: "03:50",
    trackName: "Raatan Lambiyaan",
    artists: "Jubin Nautiyal, Others",
  },
  {
    time: "02:48",
    trackName: "Desires",
  ...
  },
  {
    time: "03:39",
    trackName: "Doobey",
    artists: "OAFF, Kausar Munir, Lothika",
  },
  {
    time: "03:48",
    trackName: "Ranjha",
    artists: "B Praak, Jasleen, Romy, Anvita Dutt",
  },
  {
    time: "03:26",
    trackName: "Insane",
    artists: "AP Dhillon, Gurinder Gill, Others",
  },
  {
    time: "03:44",
    trackName: "Srivalli",
    artists: "Javed Ali, Devi Sri Prasad",
  },
  {
    time: "03:58",
    trackName: "Heat Waves",
    artists: "Glass Animals (Dreamland)",
  },
  {
    time: "01:54",
    trackName: "Tere Te",
  ...
  {
    time: "04:51",
    trackName: "Rait Zara Si",
    artists: "AR Rahman, Arijit Singh, Sashaa",
  },
  {
    time: "02:04",
    trackName: "Spaceship",
    artists: "AP Dhillon, Ghinda Kahlon, Gminxr",
  },
  { time: "04:30", trackName: "Tu Aake Dekhle", artists: "King" },
  {
    time: "04:32",
    trackName: "Adiye",
    artists: "Dhibu Ninan Thomas, Kapil Kapilan",
  },
  {
    time: "03:32",
  ...
  },
  {
    time: "02:40",
    trackName: "Ma Belle",
    artists: "AP Dhillon, Amari, Others",
  },
  {
    time: "02:59",
    trackName: "Gehraiyaan",
    artists: "OAFF, Ankur Tiwari, Lothika",
  },
  ...
  { time: "03:08", trackName: "Love Nwantiti", artists: "CKay, DJ Yo!, Ax'el" },
  {
    time: "02:53",
    trackName: "Enemy",
    artists: "Imagine Dragons, JID, Arcane",
  },
  { time: "02:49", trackName: "Let Me Down Slowly", artists: "Alec Benjamin" },
  {
    time: "03:51",
    trackName: "Dil Ko Karaar Aaya",
    artists: "Yasser Desai, Neha Kakkar",
  },
...
function loadPage(elem) {
  ...
  if (elemId === "logo" || elemId == "home") {
    ...
    page = "createPlaylist.html";
  } else if (elemId === "uploadAlbum") {
    page = "Upload/uploadAlbum.html";
  } else if (elemId === "uploadSong") {
...
function onUpload(elem) {
  const elemId = $(elem).attr("id");
  var page = "";
  if (elemId === "uploadSong") {
    page = "Upload/uploadSong.php";
  } else if (elemId === "uploadPodcast") {
    page = "Upload/uploadPodcast.html";
  }
  $("#content-placeholder").load(page);
